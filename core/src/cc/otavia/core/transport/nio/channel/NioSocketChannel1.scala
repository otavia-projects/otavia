...
import cc.otavia.core.channel.socket.SocketChannelWriteHandleFactory
import cc.otavia.core.channel.{ChannelOption, ChannelShutdownDirection, FileRegion}
 ...
 */
class NioSocketChannel1(socket: SocketChannel, protocolFamily: ProtocolFamily)
