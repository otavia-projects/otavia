...
import cc.otavia.core.util.CompressionBooleanInt
import cc.otavia.handler.codec.ByteToMessageDecoder.*
import cc.otavia.handler.codec.ByteToMessageDecoder.CompositeBufferCumulator.prepareInForCompose
import cc.otavia.handler.codec.ByteToMessageDecoder.MergeCumulator.expandAccumulationAndWrite
...
abstract class ByteToMessageDecoder(private val cumulator: Cumulator)
     ...
     *  [[cc.otavia.core.channel.ChannelOption.AUTO_READ]] is false.
     */
